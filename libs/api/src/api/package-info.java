/**
 * The {@link api} package contains the API definitions for the Chess MVC (Model-View-Controller) game.
 ...
 * The {@link api.IChessController } API defines the interactions between the user interface and the game model.
 ...
 * The {@link api.IChessModel} API outlines the structure and behavior of the Chess game model. It includes
 ...
 * The {@link api.IChessView} API describes the interfaces that must be implemented by classes responsible for
