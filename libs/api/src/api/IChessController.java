...
/**
 * The {@link IChessController} interface combines the functionalities of managing chess game logic and
 * handling user interactions for a Chess MVC (Model-View-Controller) game.
 * It extends both {@link IChess} for game state and {@link IGame} for game actions, providing a unified
...
public interface IChessController extends IChess, IGame {
	 ...
	 *
	 * @return A string representing an error message, or an empty string if there is no error.
	 */
