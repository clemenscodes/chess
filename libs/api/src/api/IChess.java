...
/**
 * The {@link IChess} interface defines functions related to the board state in
 * a Forsyth-Edwards Notation (FEN) string.
 * It is intended to be implemented by classes that manage and represent the
...
public interface IChess {
     ...
     *
     * @return An array representing the piece placement on the chessboard in FEN
     *         notation.
     */
     ...
     *
     * @return {@code true} if it is the white player's turn, {@code false}
     *         otherwise.
     */
    boolean isWhite();
     ...
     *
     * @return {@code true} if white king-side castling is available, {@code false}
     *         otherwise.
     */
     ...
     *
     * @return {@code true} if white queen-side castling is available, {@code false}
     *         otherwise.
     */
     ...
     *
     * @return {@code true} if black king-side castling is available, {@code false}
     *         otherwise.
     */
     ...
     *
     * @return {@code true} if black queen-side castling is available, {@code false}
     *         otherwise.
     */
    ...
    /**
     * Gets the half-move clock, representing the number of half-moves since the
