...
public class BishopTest {
	...
	void setup() {
		...
		piece = new PieceMock(Pieces.BlackBishop, Bitboard.getSingleBit(Square.getIndex(e4)));
	}
	...
	void shouldGetAttacksFromBottomLeft() {
		piece = new PieceMock(Pieces.BlackBishop, Bitboard.getSingleBit(Square.getIndex(a1)));
		IBitboard attacks = piece.getAttacks(piece.getBitboard(), board);
		String expected =
			"""
			00000001
	...
	void shouldGetAttacksFromBottomRight() {
		piece = new PieceMock(Pieces.BlackBishop, Bitboard.getSingleBit(Square.getIndex(h1)));
		IBitboard attacks = piece.getAttacks(piece.getBitboard(), board);
		String expected =
			"""
			10000000
	...
	void shouldGetAttacksFromTopLeft() {
		piece = new PieceMock(Pieces.BlackBishop, Bitboard.getSingleBit(Square.getIndex(a8)));
		IBitboard attacks = piece.getAttacks(piece.getBitboard(), board);
		String expected =
			"""
			00000000
	...
	void shouldGetAttacksFromTopRight() {
		piece = new PieceMock(Pieces.BlackBishop, Bitboard.getSingleBit(Square.getIndex(h8)));
		IBitboard attacks = piece.getAttacks(piece.getBitboard(), board);
		String expected =
			"""
			00000000
