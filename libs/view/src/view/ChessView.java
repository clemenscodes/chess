...
/**
 * The {@link ChessView} class implements the {@link IChessView} interface and
 * extends the Processing {@link PApplet}.
 * It serves as the graphical user interface (GUI) for the chess game, providing
 * visual representation and user interaction.
 */
public class ChessView extends PApplet implements IChessView {

    /**
     * The associated chess controller implementing the {@link IChessController}
     * interface.
     */
    ...
    /**
     * Configures the size and pixel density of the game window based on the
    ...
    /**
     * Sets up the initial configuration for the chess game, including window title,
     * square size, board offsets,
    ...
    /**
     * Handles the rendering of the game window, background, error message, and
     * updates the frame.
     */
    @Override
    public void draw() {
    ...
    /**
     * Handles the processing of mouse press events by forwarding them to the chess
     * controller.
     */
    @Override
    ...
    /**
     * Handles the processing of mouse drag events by forwarding them to the chess
     * controller.
     */
    @Override
    ...
    /**
     * Handles the processing of mouse release events by forwarding them to the
     * chess controller.
     */
    @Override
    ...
    /**
     * Handles the processing of mouse move events by forwarding them to the chess
     * controller.
     */
    @Override
    ...
    /**
     * Configures the text alignment and size for displaying various elements in the
     * chess game.
     */
    ...
    /**
     * Draws the "Game Over" message on the screen, hiding unnecessary buttons and
    ...
    /**
     * Initiates the promotion button with the specified name, label, and text at
     * the given position.
     *
