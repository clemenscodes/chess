...
public class MoveListTest {
    ...
    void shouldNotMoveToSourceSquare() {
        try {
            list.makeMove(e2, e2, board, reader, writer);
    ...
    void shouldPrintMoveList() {
        list.makeMove(e2, e4, board, reader, writer);
        list.makeMove(e7, e5, board, reader, writer);
        list.makeMove(g1, f3, board, reader, writer);
        list.makeMove(b8, c6, board, reader, writer);
        String expected = """
                1. e2e4 e7e5
                2. g1f3 b8c6
                """;
    ...
    void shouldMakeWhiteBishopMove() {
        ...
        board = new Board(new ForsythEdwardsNotation(fen));
        list.makeMove(f1, b5, board, reader, writer);
    }
    ...
    void shouldMakeBlackBishopMove() {
        ...
        board = new Board(new ForsythEdwardsNotation(fen));
        list.makeMove(f8, c5, board, reader, writer);
    }
    ...
    void shouldMakeWhiteKingMove() {
        ...
        board = new Board(new ForsythEdwardsNotation(fen));
        list.makeMove(e1, g1, board, reader, writer);
    }
    ...
    void shouldMakeBlackKingMove() {
        ...
        board = new Board(new ForsythEdwardsNotation(fen));
        list.makeMove(e8, g8, board, reader, writer);
    }
    ...
    void shouldMakeWhiteQueenMove() {
        ...
        board = new Board(new ForsythEdwardsNotation(fen));
        list.makeMove(d1, d2, board, reader, writer);
    }
    ...
    void shouldMakeBlackQueenMove() {
        ...
        board = new Board(new ForsythEdwardsNotation(fen));
        list.makeMove(d8, d7, board, reader, writer);
    }
    ...
    void shouldMakeWhiteRookMove() {
        ...
        board = new Board(new ForsythEdwardsNotation(fen));
        list.makeMove(a1, d1, board, reader, writer);
    }
    ...
    void shouldMakeBlackRookMove() {
        ...
        board = new Board(new ForsythEdwardsNotation(fen));
        list.makeMove(a8, d8, board, reader, writer);
    }
}
